...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
  ...
  <xsl:template name="ihac-title">
    <xsl:choose>
      ...
      <xsl:otherwise>
        <xsl:text>miao miao</xsl:text>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>
  
  <xsl:template name="ihac-structure">
    <xsl:variable name="title">
      <xsl:call-template name="ihac-title" />
    </xsl:variable>
    ...
    <html>
      ...
      <body>
        ...
        <xsl:call-template name="ihac-body-structure" />
      </body>
    </html>
  </xsl:template>
  
  <xsl:template name="ihac-body-structure">
    <div id="metadata">
